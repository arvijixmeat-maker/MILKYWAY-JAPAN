        ...
        try {
            ...
            if (data) {
                const mapped: RecentlyViewedItem[] = data.map((item: any) => ({
                    ...
                    category: '?ÜÂìÅ', // Schema doesn't have category for recently_viewed? Check sql. 
        ...
        <div className="bg-background-light dark:bg-background-dark font-display text-[#0e1a18] dark:text-white min-h-screen pb-20">
            ...
            <nav className="sticky top-0 z-50 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800">
                <div className="flex items-center p-4 justify-between max-w-md mx-auto">
                    ...
                    <h2 className="text-lg font-bold leading-tight tracking-tight flex-1 text-center pr-10">?ÄËøëË¶ã?üÂïÜ??/h2>
                </div>
            </nav>
            ...
            <main className="max-w-md mx-auto">
                {recentlyViewed && recentlyViewed.length > 0 ? (
                    <div className="p-4 space-y-3">
                        <div className="mb-4">
                            <p className="text-sm text-gray-500">??{recentlyViewed.length}‰ª?/p>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 px-6">
                        ...
                        <p className="text-gray-500 text-center mb-2">?ÄËøëË¶ã?üÂïÜ?Å„ÅØ?Ç„Çä?æ„Åõ??/p>
                        <p className="text-sm text-gray-400 text-center mb-6">?ÜÂìÅ?íÈñ≤Ë¶ß„Åó?¶„ÄÅ„ÅäÊ∞ó„Å´?•„Çä??óÖË°å„ÇíË¶ã„Å§?ë„Å¶?è„Å†?ï„ÅÑ</p>
                        <button
