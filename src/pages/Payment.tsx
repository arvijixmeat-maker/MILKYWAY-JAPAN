    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            if (!isQuote && selectedStartDate && parsedDuration) {
                ...
                newReservation.duration = `${parsedDuration.nights}Î∞?${parsedDuration.days}??;
            } else if (isQuote) {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark min-h-screen font-display">
            <SEO 
                ...
                description="?äÊîØ?ï„ÅÑ?ä„Çà?≥‰∫àÁ¥ÑÁ¢∫Ë™ç„Éö?º„Ç∏?ÇË©≥Á¥∞„ÇíÁ¢∫Ë™ç?ó„Å¶‰∫àÁ¥Ñ?íÁ¢∫ÂÆö„Åï?õ„Å¶?è„Å†?ï„ÅÑ??
            />
            <div className="max-w-[430px] mx-auto bg-white dark:bg-zinc-900 min-h-screen flex flex-col relative overflow-x-hidden shadow-2xl">
                ...
                <div className="flex-1 overflow-y-auto pb-48">
                    ...
                    <div className="px-5 py-8">
                        <h3 className="text-[#0e1a18] dark:text-white text-lg font-bold mb-6">{t('payment.paypal_invoice_title', { defaultValue: '‰∫àÁ¥Ñ?ë„ÅÆ?äÊîØ?ï„ÅÑ?´„Å§?Ñ„Å¶' })}</h3>
                        <div className="border border-blue-100 dark:border-blue-900/50 rounded-2xl bg-blue-50/50 dark:bg-blue-900/10 overflow-hidden shadow-sm">
                            <div className="flex items-center gap-4 p-5">
                                ...
                                <div className="flex-1">
                                    <p className="text-[#0e1a18] dark:text-white font-bold text-[15px] mb-1">{t('payment.paypal_invoice_method', { defaultValue: 'PayPal Ë´ãÊ±Ç??(E?°„Éº??' })}</p>
                                    <p className="text-[13px] text-gray-600 dark:text-gray-400 leading-relaxed">
                                        {t('payment.paypal_invoice_desc1', { defaultValue: '‰∫àÁ¥Ñ?≥„ÅóËæº„ÅøÂÆå‰∫ÜÂæå„ÄÅ„Åî?•Âäõ?Ñ„Åü?†„ÅÑ?ü„É°?º„É´?¢„Éâ?¨„ÇπÂÆõ„Å´PayPal??´ãÊ±ÇÊõ∏?í„Åä?Å„Çä?Ñ„Åü?ó„Åæ?ô„Ä? })}
                                        <br />
                                        {t('payment.paypal_invoice_desc2', { defaultValue: '?°„Éº?´ÂÜÖ??É™?≥„ÇØ?ã„Çâ?Å„ÇØ?¨„Ç∏?É„Éà?´„Éº?âÁ≠â?ßÂÆâ?®„Å´?äÊîØ?ï„ÅÑ?Ñ„Åü?†„Åë?æ„Åô?? })}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="mt-6 p-4 bg-gray-50 dark:bg-zinc-800/50 rounded-xl">
                            ...
                            <ul className="text-xs text-gray-500 dark:text-gray-400 space-y-2 list-disc pl-4">
                                <li>{t('payment.paypal_notices.check_email', { defaultValue: 'Ë´ãÊ±Ç?∏„É°?º„É´?´„Åä??âï?ÑÊúü?ê„ÅåË®òËºâ?ï„Çå?¶„ÅÑ?æ„Åô?ÇÊúü?êÂÜÖ?´Ê±∫Ê∏à„Çí?äÈ°ò?Ñ„Åó?æ„Åô?? })}</li>
