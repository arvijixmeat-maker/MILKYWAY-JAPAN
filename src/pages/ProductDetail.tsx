...
export const ProductDetail: React.FC = () => {
    ...
    const handleShare = async () => {
        ...
        try {
            if (navigator.share) {
                ...
                showToast('success', 'ÎßÅÌÅ¨Í∞Ä Î≥µÏÇ¨?òÏóà?µÎãà??');
            }
        } catch (error) {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-[#0e1a18] dark:text-white min-h-screen pb-24 font-display">
            <SEO
                title={product.name}
                description={product.description || product.highlights?.[0]?.description || `${product.name} - ?¢„É≥?¥„É´?ÖË°å?ª„É¢?≥„Ç¥?´„ÉÑ?¢„Éº?™„ÇâMilkyway Japan?ÇÁâπ?•„ÅßÈ≠ÖÂäõ?Ñ„Å™?¢„É≥?¥„É´Ë¶≥ÂÖâ‰ΩìÈ®ì?í„Åî?êÊ°à?ó„Åæ?ô„Ä?}
                image={product.mainImages?.find(img => !img.startsWith('data:'))}
                keywords={`${product.category}, ${product.tags.join(', ')}, ?¢„É≥?¥„É´?ÖË°å, ?¢„É≥?¥„É´Ë¶≥ÂÖâ, ?¢„É≥?¥„É´?Ñ„Ç¢??}
                                                ...
                                                <div className="mt-4 pt-3 border-t border-slate-200/80 dark:border-slate-700/60 space-y-1">
                                                    {dayInfo.meals!.breakfast && (
                                                        <div className="flex items-start gap-2.5 text-[13px] text-slate-600 dark:text-slate-300 py-1">
                                                            ...
                                                            <div className="font-bold text-slate-700 dark:text-slate-200 shrink-0 whitespace-nowrap w-28 flex items-baseline">
                                                                <span>?ùÈ£ü</span>
                                                                <span className="text-[10px] text-slate-400 font-normal ml-1.5">(?°„Çá?Ü„Åó?á„Åè)</span>
                                                            </div>
                                                    ...
                                                    {dayInfo.meals!.lunch && (
                                                        <div className="flex items-start gap-2.5 text-[13px] text-slate-600 dark:text-slate-300 py-1">
                                                            ...
                                                            <div className="font-bold text-slate-700 dark:text-slate-200 shrink-0 whitespace-nowrap w-28 flex items-baseline">
                                                                <span>?ºÈ£ü</span>
                                                                <span className="text-[10px] text-slate-400 font-normal ml-1.5">(?°„ÇÖ?Ü„Åó?á„Åè)</span>
                                                            </div>
                                                    ...
                                                    {dayInfo.meals!.dinner && (
                                                        <div className="flex items-start gap-2.5 text-[13px] text-slate-600 dark:text-slate-300 py-1">
                                                            ...
                                                            <div className="font-bold text-slate-700 dark:text-slate-200 shrink-0 whitespace-nowrap w-28 flex items-baseline">
                                                                <span>Â§ïÈ£ü</span>
                                                                <span className="text-[10px] text-slate-400 font-normal ml-1.5">(?Ü„ÅÜ?ó„Çá??</span>
                                                            </div>
                                                    ...
                                                    {dayInfo.accommodation && (
                                                        <div className="flex items-start gap-2.5 text-[13px] text-slate-600 dark:text-slate-300 py-1 mt-1 font-medium">
                                                            ...
                                                            <div className="font-bold text-slate-700 dark:text-slate-200 shrink-0 whitespace-nowrap w-28 flex items-baseline">
                                                                <span>ÂÆøÊ≥ä</span>
                                                                <span className="text-[10px] text-slate-400 font-normal ml-1.5">(?ó„ÇÖ?è„ÅØ??</span>
                                                            </div>
