...
export const TravelGuide: React.FC = () => {
    ...
    return (
        <div className="bg-[#f8f7f8] dark:bg-background-dark text-text-primary dark:text-white pb-24 min-h-screen font-display">
            <SEO
                title={`?¢ãƒ³?´ãƒ«?…è¡Œ?¬ã‚¤??| ?¢ãƒ³?´ãƒ«?„ã‚¢?¼ãƒ»?¢ãƒ³?´ãƒ«è¦³å…‰?…å ±?Milkyway Japan??}
                description="?¢ãƒ³?´ãƒ«?…è¡Œ??¿…?ˆæƒ…?±ï¼?¢ãƒ³?´ãƒ«?„ã‚¢?¼ã®æº–å‚™?ãƒ¢?³ã‚´?«ã®?ºæœ¬?…å ±?åœ°?Ÿåˆ¥?¬ã‚¤?‰ã€ãƒ¢?³ã‚´?«æ–‡?–ã‚„?°ãƒ«?¡æƒ…?±ã‚’?ã‚§?ƒã‚¯?‚ãƒ¢?³ã‚´?«ä¹—é¦¬æ—…è¡Œã€ã‚´?“ç ‚æ¼ ãƒ„?¢ãƒ¼??Ÿº?¬æƒ…?±ã‚‚??
                keywords="?¢ãƒ³?´ãƒ«?…è¡Œ?¬ã‚¤?? ?¢ãƒ³?´ãƒ«?„ã‚¢?¼æº–?? ?¢ãƒ³?´ãƒ«?…å ±, ?¢ãƒ³?´ãƒ«?‡åŒ–, ?¢ãƒ³?´ãƒ«?™ç†, ?¢ãƒ³?´ãƒ«?…è¡Œæº–å‚™, ?¢ãƒ³?´ãƒ«ä¹—é¦¬?…è¡Œ?¬ã‚¤??
                url="/travel-guide"
                breadcrumb={[
                    { name: '?›ãƒ¼??, url: '/' },
                    { name: '?¢ãƒ³?´ãƒ«?…è¡Œ?¬ã‚¤??, url: '/travel-guide' }
                ]}
            />
