...
export const horseTrekFields: DesignTemplateField[] = [
    ...
    { key: 'tab4_text', label: '탭 4 내용', type: 'text', section: '13 1일차 상세', default: '미니사막' },
    ...
    { key: 'd1_e1', label: '일정 1 내용', type: 'textarea', section: '13 1일차 상세', default: '울란바토르 공항픽업\n환전 / 장보기' },
    ...
    { key: 'd1_e3', label: '일정 3 내용', type: 'textarea', section: '13 1일차 상세', default: '캠프도착 및 석식\n자유시간 (선셋, 별 구경)' },
    {
