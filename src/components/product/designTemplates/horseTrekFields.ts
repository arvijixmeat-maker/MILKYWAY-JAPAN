...
export const horseTrekFields: DesignTemplateField[] = [
    ...
    { key: 'price_head', label: '표 헤더 (| 구분)', type: 'text', section: '18 투어 가격', default: '参加人数|予約金（円）|残金（円）|お一人様あたりの合計金額' },
    ...
    { key: 'gt3_spec', label: '게르 유형 3 설비', type: 'textarea', section: '19 예약 전 확인사항', default: '電気：使用可能 シャワー：ゲル内完備 トイレ：ゲル内完備\n暖房：完備' },
