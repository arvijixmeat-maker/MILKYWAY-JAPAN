...
export const horseTrekFields: DesignTemplateField[] = [
    ...
    { key: 'd1_stay', label: '숙박 이름', type: 'text', section: '13 1일차 상세', default: '旅行者向けゲルキャンプ', presets: ['旅行者向けゲルキャンプ', '旅行者向けゲル(高級タイプ)', '旅行者向けゲル(一般タイプ)', 'モダンゲル', 'モダンペンション', 'ホテル(4つ星)', 'ホテル(3つ星)', 'ゲストハウス'] },
    {
