...
export const horseTrekFields: DesignTemplateField[] = [
    ...
    { key: 'tab1_label', label: '1일차 라벨', type: 'text', section: '13 1일차 상세', default: '1DAY' },
    {
        ...
        presets: [
            ...
            { label: '미니사막(엘슨타사르해)', value: 'エルセンタサルハイ' },
            { label: '카라코룸', value: 'カラコルム' },
            { label: '쳉헤르 온천', value: 'ツェンヘル温泉' },
            { label: '테를지', value: 'テレルジ国立公園' },
            { label: '홉스굴', value: 'フブスグル湖' },
            { label: '고비사막', value: 'ゴビ砂漠' },
            { label: '바양작', value: 'バヤンザグ' },
            { label: '욜링암', value: 'ヨリンアム' },
            { label: '차강소브라가', value: 'ツァガーンスワルガ' },
            { label: '승마 트레킹', value: '乗馬トレッキング' },
            { label: '시내관광', value: '市内観光' },
            { label: '귀국', value: '帰国' },
        ],
    },
    ...
    { key: 'd1_kicker', label: '카드 작은 제목', type: 'text', section: '13 1일차 상세', default: 'Elsentasarkhai' },
    { key: 'd1_head', label: '카드 큰 제목', type: 'text', section: '13 1일차 상세', default: '엘슨타사르해' },
    { key: 'd1_body', label: '카드 본문', type: 'textarea', section: '13 1일차 상세', default: '끝없이 펼쳐진 초원과 황금빛 모래언덕이 한곳에서 만나는 몽골의 특별한 여행지입니다. ‘작은 고비사막’이라고도 불리는 엘슨타사르해에서는 낙타 체험과 샌드보드를 즐기며 몽골 사막의 매력을 가까이에서 느낄 수 있습니다.' },
    ...
    { key: 'd1_route_title', label: '일정 제목', type: 'text', section: '13 1일차 상세', default: 'ツアー日程' },
    {
        key: 'd1_sched_count', label: '일정표 줄 수', type: 'text', section: '13 1일차 상세', default: '3',
        presets: ['1', '2', '3', '4', '5', '6'],
        help: '시간대가 더 필요하면 늘리세요.',
    },
    { key: 'd1_t1', label: '일정 1 시간', type: 'text', section: '13 1일차 상세', default: '10:00' },
    {
        key: 'd1_e1', label: '일정 1 내용', type: 'textarea', section: '13 1일차 상세', default: '空港お迎え\n両替・買い出し',
        presetLines: [
            { label: '공항 픽업', value: '空港お迎え' },
            { label: '환전 / 장보기', value: '両替・買い出し' },
            { label: '조식', value: '朝食' },
            { label: '중식', value: '昼食' },
            { label: '석식', value: '夕食' },
            { label: '이동', value: '移動' },
            { label: '캠프 도착', value: 'キャンプ到着' },
            { label: '자유시간', value: '自由時間' },
            { label: '승마 체험', value: '乗馬体験' },
            { label: '낙타 체험', value: 'ラクダ乗り体験' },
            { label: '온천욕', value: '温泉入浴' },
            { label: '시내 관광', value: '市内観光' },
            { label: '별 구경', value: '星空観賞' },
            { label: '공항 배웅', value: '空港お見送り' },
        ],
    },
    { key: 'd1_t2', label: '일정 2 시간', type: 'text', section: '13 1일차 상세', default: '13:00' },
    {
        key: 'd1_e2', label: '일정 2 내용', type: 'textarea', section: '13 1일차 상세', default: '昼食\n移動',
        presetLines: [
            { label: '공항 픽업', value: '空港お迎え' },
            { label: '환전 / 장보기', value: '両替・買い出し' },
            { label: '조식', value: '朝食' },
    ...
    {
        key: 'd1_e3', label: '일정 3 내용', type: 'textarea', section: '13 1일차 상세', default: 'キャンプ到着\n夕食\n自由時間',
        presetLines: [
            { label: '공항 픽업', value: '空港お迎え' },
            { label: '환전 / 장보기', value: '両替・買い出し' },
            { label: '조식', value: '朝食' },
    ...
    { key: 'd1_t4', label: '일정 4 시간', type: 'text', section: '13 1일차 상세', default: '' },
    {
        key: 'd1_e4', label: '일정 4 내용', type: 'textarea', section: '13 1일차 상세', default: '',
        presetLines: [
            { label: '공항 픽업', value: '空港お迎え' },
            { label: '환전 / 장보기', value: '両替・買い出し' },
            { label: '조식', value: '朝食' },
    ...
    { key: 'd1_t5', label: '일정 5 시간', type: 'text', section: '13 1일차 상세', default: '' },
    {
        key: 'd1_e5', label: '일정 5 내용', type: 'textarea', section: '13 1일차 상세', default: '',
        presetLines: [
            { label: '공항 픽업', value: '空港お迎え' },
            { label: '환전 / 장보기', value: '両替・買い出し' },
            { label: '조식', value: '朝食' },
    ...
    { key: 'd1_t6', label: '일정 6 시간', type: 'text', section: '13 1일차 상세', default: '' },
    {
        key: 'd1_e6', label: '일정 6 내용', type: 'textarea', section: '13 1일차 상세', default: '',
        presetLines: [
            { label: '공항 픽업', value: '空港お迎え' },
            { label: '환전 / 장보기', value: '両替・買い出し' },
            { label: '조식', value: '朝食' },
    ...
    {
        key: 'd1_meal_b', label: '조식', type: 'text', section: '13 1일차 상세', default: 'なし',
        presets: [
            { label: '없음', value: 'なし' },
            { label: '현지식', value: '現地食' },
            { label: '캠프식', value: 'キャンプ食' },
            { label: '호텔식', value: 'ホテル食' },
            { label: '특식(허르헉)', value: '特別料理（ホルホグ）' },
            { label: '샤브샤브', value: 'しゃぶしゃぶ' },
            { label: '도시락', value: 'お弁当' },
            { label: '기내식', value: '機内食' },
            { label: '자유식', value: '各自自由食' },
        ],
    },
    {
        key: 'd1_meal_l', label: '중식', type: 'text', section: '13 1일차 상세', default: '現地食',
        presets: [
            { label: '없음', value: 'なし' },
            { label: '현지식', value: '現地食' },
            { label: '캠프식', value: 'キャンプ食' },
    ...
    {
        key: 'd1_meal_d', label: '석식', type: 'text', section: '13 1일차 상세', default: 'キャンプ食',
        presets: [
            { label: '없음', value: 'なし' },
            { label: '현지식', value: '現地食' },
            { label: '캠프식', value: 'キャンプ食' },
    ...
    {
        key: 'd1_stay', label: '숙박 이름', type: 'text', section: '13 1일차 상세', default: '旅行者向けゲルキャンプ',
        presets: [
            { label: '여행자 게르 캠프', value: '旅行者向けゲルキャンプ' },
            { label: '고급 게르', value: '旅行者向けゲル(高級タイプ)' },
            { label: '일반 게르', value: '旅行者向けゲル(一般タイプ)' },
            { label: '모던 게르', value: 'モダンゲル' },
            { label: '모던 펜션', value: 'モダンペンション' },
            { label: '4성급 호텔', value: 'ホテル(4つ星)' },
            { label: '3성급 호텔', value: 'ホテル(3つ星)' },
            { label: '게스트하우스', value: 'ゲストハウス' },
        ],
    },
    {
        ...
        default: '· 電気使用可能\n· シャワー可能（屋外・共用）\n· トイレ（屋外・共用）',
        presetLines: [
            { label: '전기사용 가능', value: '· 電気使用可能' },
            { label: '샤워가능(외부/공용)', value: '· シャワー可能（屋外・共用）' },
            { label: '샤워가능(게르 내)', value: '· シャワー可能（ゲル内）' },
            { label: '화장실(외부/공용)', value: '· トイレ（屋外・共用）' },
            { label: '화장실(게르 내)', value: '· トイレ（ゲル内）' },
            { label: '온수 사용 가능', value: '· 温水利用可能' },
            { label: '난방 완비', value: '· 暖房完備' },
