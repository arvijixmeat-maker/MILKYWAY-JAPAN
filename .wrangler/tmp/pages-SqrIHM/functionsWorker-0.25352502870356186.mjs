...
var handle = /* @__PURE__ */ __name((app21) => (eventContext) => {
  return app21.fetch(
...
// api/products.ts
var app = new Hono2();
var safeParse = /* @__PURE__ */ __name((val, fallback = []) => {
...
var toJson = /* @__PURE__ */ __name((val) => {
  if (typeof val === "string") return val;
  return JSON.stringify(val || []);
}, "toJson");
var g = /* @__PURE__ */ __name((data, snakeKey, camelKey, defaultVal = "") => {
...
// [[path]].ts
var getAbsoluteImageUrl = /* @__PURE__ */ __name((url) => {
...
// ../.wrangler/tmp/pages-SqrIHM/functionsRoutes-0.44117590226524106.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-Egz1QM/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Egz1QM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.25352502870356186.mjs.map
