...
export const onRequestGet: PagesFunction<Env> = async (context) => {
    try {
        ...
        const urls = [
            ...
            { loc: `${baseUrl}/mongol-travel`, lastmod: today, changefreq: 'weekly', priority: '0.9' },
            { loc: `${baseUrl}/mongol-tour`, lastmod: today, changefreq: 'weekly', priority: '0.9' },
            { loc: `${baseUrl}/horse-riding-tour`, lastmod: today, changefreq: 'weekly', priority: '0.9' },
            { loc: `${baseUrl}/gobi-desert`, lastmod: today, changefreq: 'weekly', priority: '0.9' },
